...
public class AliyunOSSClientUtil
{
     ...
     * */
    public static  String uploadObject2OSS(OSSClient ossClient, MultipartFile file, String name) {
        ...
        try {
            ...
            //上传文件   (上传文件流的形式)
            PutObjectResult putResult = ossClient.putObject(BACKET_NAME, name, is, metadata);
            //解析结果
